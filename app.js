...
function sumArray(sumArr) { //eslint-disable-line
  //var sumOfThree = sum(sum(2, 3)[0],4)[0];
...
function multiplyArray(multArr) { //eslint-disable-line
  var firstSum = multiply(multArr[0], multArr[1]);
  var secondSum = multiply(firstSum[0], multArr[2]);
  var multiOfThree = secondSum[0];
  var stringofthreeMulti = 'The numbers ' + multArr + ' have a product of ' + multiOfThree + '.'
  console.log(stringofthreeMulti);
  console.log(multiOfThree);
  return[multiOfThree, stringofthreeMulti]
}
